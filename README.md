...
<p align="center">
  <img src="./docs/hero.webp" alt="NDVI over the Salton Sea and Imperial Valley, rendered browser-side from Sentinel-2 COGs with an Emrld colormap" height="500" />
</p>
...
**▶ [Live demo](https://kentstephen.github.io/sentinel-2-cog-deckgl-raster/)** — runs entirely in your browser; no server, no backend.
